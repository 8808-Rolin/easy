...
INSERT INTO user (username,realname,student_number,college_id,password,email,phone,sex,birth,is_open_zone,level,user_avatar,notice,intro) VALUES ("Chen","陈一发","202006070003",1,"5f4dcc3b5aa765d61d8327deb882cf99","test_account_03@foxmail.com","18906070002",0,"2000-01-03",1,1,"/images/default.jpg","这是测试用户，这是我的空间公告","该用户真是懒到不行啦~连简介都要代劳");
...
INSERT INTO action (a_id,title,content_id,start_time,end_time,is_approved,position) VALUES (3,"举办Lovelive4",11,"2021-11-27 18:00:00","2021-12-08 12:00:00",1,"学校天台");
